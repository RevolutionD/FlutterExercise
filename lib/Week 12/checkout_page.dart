        ...
        child: SingleChildScrollView(
          ...
          child: Flex(
            ...
            children: [
              _buildCard(
                children: [
                  const Text('Cart Summary', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              _buildCard(
                children: [
                  const Text('Recipient Details', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              _buildCard(
                children: [
                  const Text('Delivery Information', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      OutlinedButton(
                        style: ButtonStyle(
                          ...
                          minimumSize: MaterialStateProperty.all(Size(MediaQuery.of(context).size.width / 2 - 40, 40)),
                        ),
                        onPressed: () {},
                      ...
                      OutlinedButton(
                        ...
                        onPressed: () {},
                        child: const Text('Pick Up', style: TextStyle(fontSize: 15)),
                      ),
                    ],
                  ),
                  const SizedBox(height: 10),
                  _textField('424/1D Palanwatta, Pannipitiya', enableSuffix: true),
                ],
              ),
              const SizedBox(height: 20),
              _buildCard(children: [
                const Text('Delivery Date', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                Row(),
              ])
            ],
          ),
  ...
  Row _duoInfo(String title, String result, {bool isTotal = false}) {
    return Row(
      ...
      children: [
        ...
        Text(result, style: TextStyle(fontWeight: isTotal ? FontWeight.bold : FontWeight.normal, fontSize: isTotal ? 18 : 16)),
      ],
    );
  }
